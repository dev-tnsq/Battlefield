...
if (existsSync('deployment.json')) {
  ...
  gameHubId = deploymentInfo?.gameHubId || gameHubId;
  ...
  gameHubId = getEnvValue(env, 'VITE_GAME_HUB_CONTRACT_ID', gameHubId);
  wallets = {
...
console.log("  1) bun --cwd=battleship-frontend run build");
